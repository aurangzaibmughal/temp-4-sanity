...
function TopCategories() {
  const categories = [
    { id: 1, img: "/image 20.png", name: "Mini LCW Chair", price: "$56.00" },
    { id: 2, img: "/image 1168.png", name: "Mini LCW Chair", price: "$56.00" },
    { id: 3, img: "/imagef33.png", name: "Mini LCW Chair", price: "$56.00" },
    { id: 4, img: "/image 20.png", name: "Mini LCW Chair", price: "$56.00" },
  ];
